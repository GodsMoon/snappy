...
import com.nightshadelabs.snappy.view.AutoFitTextureView;
...
public class Camera2BasicFragment extends Fragment
    ...
    public static Camera2BasicFragment newInstance(Story story) {
        Camera2BasicFragment fragment = new Camera2BasicFragment();
        Bundle bundle = new Bundle();
        bundle.putSerializable(Story.BUNDLE_ID, story);
    ...
    public void onViewCreated(final View view, Bundle savedInstanceState) {
        ...
        mImageViewOverlay = (ImageView) view.findViewById(R.id.imageViewOverlay);
        mImageViewOverlay.setImageAlpha(50);
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mStory = (Story )getArguments().getSerializable(Story.BUNDLE_ID);

        //mFile = new File(getActivity().getExternalFilesDir(null), "pic.jpg");
        try {
            mFile = ((BaseActivity) getActivity()).newFileFor(mStory);
        } catch (IOException e) {
            e.printStackTrace();
        }
        setOverlay();
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            openCamera(mTextureView.getWidth(), mTextureView.getHeight(), null);
        } else {
    ...
    private int getOrientation(int rotation) {
        //mImageViewOverlay.setImageResource(android.R.color.transparent);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            ...
            case R.id.switch_camera: {
                ...
                String switchCamera = mCurrentCameraId == mCameraFrontId ? mCameraBackId : mCameraFrontId;
                openCamera(mTextureView.getWidth(), mTextureView.getHeight(), switchCamera);
            }
        }
    }
